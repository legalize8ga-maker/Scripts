...
---
-- [Private] Cleans up all tracked parts and connections.
---
function Modules.NoClip:_cleanup()
    ...
    for part in pairs(self.State.TrackedParts) do
        if part and part.Parent then
            -- A simple heuristic to restore collision. This assumes parts are normally collidable.
            -- This is generally safe for character parts.
...
function Modules.NoClip:Enable()
    ...
    -- The Enforcer Loop: This is the core fix for the "silently disabling" issue.
    -- It runs every frame before physics are simulated and re-asserts that all tracked
    -- parts are non-collidable, fighting any server-side changes.
...
RegisterCommand({
    ...
    Description = "Sets the time to night on your client. Usage: night [hour]"
}, function(args)
...
RegisterCommand({Name = "stats", Aliases = {}, Description = "Edit and lock your properties."}, function() loadstringCmd("https://raw.githubusercontent.com/haileybae12/Zukasscript/refs/heads/main/editstats.txt", "Loading Stats..") end)
...
RegisterCommand({Name = "reload", Aliases = {"update", "exec"}, Description = "Reloads and re-executes the admin script from the GitHub source."}, function() loadstringCmd("https://raw.githubusercontent.com/haileybae12/Zukasscript/refs/heads/main/Main.lua", "Reloading admin from source...") end)
...
RegisterCommand({Name = "ketamine", Aliases = {"kspy"}, Description = "Warning: may crash on xeno"}, function() loadstringCmd("https://raw.githubusercontent.com/haileybae12/Zukasscript/refs/heads/main/remotes.lua", "Loading SimpleSpy...") end)
RegisterCommand({Name = "nocooldown", Aliases = {"ncd"}, Description = "For https://www.roblox.com/games/14419907512/Zombie-game"}, function() loadstringCmd("https://raw.githubusercontent.com/haileybae12/Zukasscript/refs/heads/main/NocooldownsZombieUpd3.txt", "Loading Cooldownremover...") end)
