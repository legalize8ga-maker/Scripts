--[[i don't know what im gonna do with this, i skidded it from cherry]]
...
local codeBox = script:FindFirstChild("CodeBox") and require(script.CodeBox) or loadstring(request({Url = "https://raw.githubusercontent.com/legalize8ga-maker/Scripts/refs/heads/main/CodeBox.lua", Method = "GET"}).Body)()
